...
@WebServlet("/managerC1ViewR_RequestsById")
public class ManagerC1ViewR_RequestsByIdServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(session != null) {
				try {
					int eid = Integer.parseInt(req.getParameter("R_RequestsById"));
					ArrayList<R_Request> reqList = rri.getR_RequestById(eid);
